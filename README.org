...
|       |                                      | Due date                   |
|-------+--------------------------------------+----------------------------|
|     1 | Complete questions in [[./hws/HW1.ipynb][this notebooks]] | Monday 21 th Jan 11.59 p.m |
|       |                                      |                            |
|-------+--------------------------------------+----------------------------|
|     2 | Complete questions in [[./hws/HW2.ipynb][this]]  notebook | Friday 25 th Jan 11.59 p.m |
|       |                                      |                            |
...
|        |                                  |                                                                                                                                                       |
|--------+----------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------|
| 23 Jan | [[./https://mybinder.org/v2/gh/psnegi/data_science_tools1/master?filepath=notebooks/Data_science_at_command_prompt.ipynb][data science at command prompt]]   |                                                                                                                                                       |
|--------+----------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------|
|        |                                  |                                                                                                                                                       |
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/sophearathchea/data_science_tools1/blob/master/hws/HW2.ipynb/master)
